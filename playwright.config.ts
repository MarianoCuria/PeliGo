 ...
 *
 * The Next.js app fetches TMDB data server-side, so we can't intercept those
 * requests from the browser. Instead we boot a local mock TMDB server and point
 * the app at it via TMDB_BASE_URL. This keeps the suite deterministic and
 * runnable in CI without a real TMDB_API_KEY.
 */
